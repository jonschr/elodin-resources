...
function ers_each_resource() {
	...
	echo '<div class="featured-wrap">';
		echo '<div class="resource-content-wrap">';
			echo '<div class="resource-content-inner">';
				...
				do_action( 'ers_do_resource_content_inner' );
	...
	do_action( 'ers_do_resource_content_after' );
...
function ers_resource_content_inner() {
...
add_action( 'ers_do_resource_content_inner', 'ers_resource_content_inner' );